...
function validateForm() {
	...
	if (name.value === "") {
		...
		name_validation.parentNode.style.backgroundColor = "#FFF0F5";
		} else {
	...
	if (message.value === "") {
		...
		message_validation.parentNode.style.backgroundColor = "#FFF0F5";
		} else {
	...
	if (email.value === "") {
		...
		email_validation.parentNode.style.backgroundColor = "#FFF0F5";
		} else {
